...
public class DeliveryListAdminAdapter extends RecyclerView.Adapter<DeliveryListAdminAdapter.CustomViewHolder> {

    ArrayList<DeliveryListAdminData> arrayList;
    Context context;
    final int GO_TO_DETAIL = 100;

    public DeliveryListAdminAdapter(ArrayList<DeliveryListAdminData> arrayList, Context context) {
    ...
    // 리스너 객체 참조를 저장하는 변수
    private DeliveryListAdminAdapter.OnItemClickListener mListener = null;

    // OnItemClickListener 객체 참조를 어댑터에 전달하는 메서드
    public void setOnItemClickListener(DeliveryListAdminAdapter.OnItemClickListener listener)
    {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_delivery_list_admin,parent,false);
        DeliveryListAdminAdapter.CustomViewHolder customViewHolder = new DeliveryListAdminAdapter.CustomViewHolder(view);
