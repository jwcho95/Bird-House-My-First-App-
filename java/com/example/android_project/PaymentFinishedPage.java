...
public class PaymentFinishedPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date.setText(getIntent().getStringExtra("receiveDate")+" 까지");
        ...
        layoutManager = new LinearLayoutManager(PaymentFinishedPage.this);
        recyclerView.setLayoutManager(layoutManager);
        paymentFinishedAdapter = new PaymentFinishedAdapter(arrayList, PaymentFinishedPage.this);
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeBtnIntent = new Intent(PaymentFinishedPage.this, MainActivity.class);
