...
public class DeliveryListDetailAdapter extends RecyclerView.Adapter<DeliveryListDetailAdapter.CustomViewHolder> {

    ArrayList<DeliveryListDetailData> arrayList;
    Context context;

    public DeliveryListDetailAdapter(ArrayList<DeliveryListDetailData> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        DeliveryListDetailAdapter.CustomViewHolder customViewHolder = new DeliveryListDetailAdapter.CustomViewHolder(view);
